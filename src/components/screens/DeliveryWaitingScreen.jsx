  ...
  return (
    <div className={'screen tracking-screen' + (active ? ' active' : '')}>
      ...
      <div className="tracking-body">
        ...
        {storeWhatsapp ? (
          <a
            className="tracking-contact-btn"
            ...
            target="_blank"
            rel="noreferrer"
            style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 8, textDecoration: 'none', background: '#25D366', borderColor: '#25D366' }}
          >
